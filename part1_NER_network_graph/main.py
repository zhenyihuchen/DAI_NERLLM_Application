...
from graphx import build_knowledge_graph, compare_graph_metrics
...
def main():
    ...
    try:
        ...
        reduced_G = build_knowledge_graph(merged_json_path, output_gexf)


        build_knowledge_graph(merged_json_path, output_gexf)

        compare_graph_metrics(raw_G, reduced_G)
